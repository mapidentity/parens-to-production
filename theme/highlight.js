...
return He}()
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);/*! `clojure` grammar compiled for Highlight.js 11.9.0 */
...
;hljs.registerLanguage("clojure",e)})();/*! `dockerfile` grammar compiled for Highlight.js 11.9.0 */
...
;(function () {
  function run() {
    ...
    } catch (e) { /* never break the page over highlighting */ }
  }
