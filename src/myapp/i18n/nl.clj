...
(def translations
  ...
  {;; Meta
   ...
   ;; Voorstellen (pull-request-achtige merge)
   :proposal/propose "Wijzigingen voorstellen aan het origineel"
   :proposal/title "Voorgestelde wijzigingen"
   :proposal/from "Voorgesteld vanuit"
   :proposal/applies-cleanly "Wordt schoon toegepast"
   :proposal/conflict "Beide versies wijzigden dit — kies er één:"
   :proposal/keep-mine "Huidige versie behouden"
   :proposal/take-theirs "Voorgestelde versie overnemen"
   :proposal/nothing-to-merge "Deze fork heeft geen wijzigingen om terug te voegen."
   :proposal/merge "Samenvoegen"
   :proposal/resolve-and-merge "Conflicten oplossen en samenvoegen"
   :proposal/decline "Afwijzen"
   :proposal/awaiting-owner "Wacht op beoordeling door de eigenaar van het recept."
   :proposal/pending-heading "Dit recept heeft openstaande suggesties van forks."
   :proposal/review-suggestion "Bekijk een voorgestelde wijziging →"
   :proposal/stale-notice
   "Dit recept is gewijzigd tijdens je beoordeling. De merge is opnieuw berekend — beoordeel en voeg opnieuw samen."
   :proposal/unresolved-notice "Los elk conflict op voordat je samenvoegt."
