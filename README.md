...
**[▶ Watch the demo](demo.mp4)** — the dev source inspector in action: click a
...
<!-- For an inline player instead of a link: edit this README on github.com and
     drag demo.mp4 into the editor. GitHub uploads it as a user-attachments URL,
     which renders as a native video player. Committed .mp4 files only render as
     links (the blob page they open does play the video). -->
