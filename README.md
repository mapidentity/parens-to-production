...
1. **An online book** — 36 chapters (in [`chapters/`](chapters/)) that walk through
...
ops/                 the production box: systemd units, transactor config, Caddyfile, deploy scripts (ch.35-36)
test/myapp/          tests
