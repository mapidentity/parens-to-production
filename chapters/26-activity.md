...
- **The feed trusts the log's retention.** `d/since` reads what the log kept. The day this application confronts excision -- the right-to-be-forgotten machinery of the operations volume -- is the day "the log remembers everything" acquires an asterisk, and this feature inherits it.
