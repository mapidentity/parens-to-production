...
- **`(script-tag "js/dispatcher.js" {:type "module"})`** loads the dispatcher, the script that powers progressive enhancement ([the next chapter](15-morph-dispatcher.md)). It is a normal ES module, served from the classpath through the asset pipeline -- not inlined.
