...
(defmacro with-clock
  ...
  Atom-based, so the rebind survives thread boundaries — important for
  any work that crosses into the Datomic transactor."
  [c & body]
