...
(def translations
  ...
  {;; Landing page
   :home/title       "myapp — Git, maar dan voor recepten"
   :home/tagline     "Fork het recept. Behoud de afstamming."
   ...
   :dashboard/placeholder "Je recepten verschijnen hier."
...
(def translations
  ...
  {;; Landing page
   :home/title       "myapp — Git, but for recipes"
   :home/tagline     "Fork the recipe. Keep the lineage."
   ...
   :dashboard/placeholder "Your recipes will appear here."
...
A few details in these maps repay attention.
...
Starting with a library means learning its API, understanding its configuration, and working around its opinions. Starting with 30 lines of code means we understand every line, can change any behavior, and have zero dependencies to track. A 30-line solution that covers the actual requirements beats a full-featured library that covers hypothetical ones.
...
- **Automatic language detection.** The browser's Accept-Language header is parsed using Java's RFC 4647 implementation. Dutch users get Dutch. English users get English. Everyone else gets English, the default locale.
